...
-file("expr_parser.yrl", 19).

value({_, _, Value}) -> Value.
token({Token, _}) -> Token.

-file("/usr/lib64/erlang/lib/parsetools-2.1.3/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
'yeccgoto_\'E\''(8, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_11(11, Cat, Ss, Stack, T, Ts, Tzr);
'yeccgoto_\'E\''(9=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_10(_S, Cat, Ss, Stack, T, Ts, Tzr).

-compile({inline,yeccpars2_3_/1}).
-file("expr_parser.yrl", 13).
