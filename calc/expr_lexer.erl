-file("/usr/lib64/erlang/lib/parsetools-2.1.3/include/leexinc.hrl", 0).
...
-file("./expr_lexer.xrl", 18).

-file("/usr/lib64/erlang/lib/parsetools-2.1.3/include/leexinc.hrl", 14).
...
yystate(9, [10|Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line+1, Tlen+1, 8, Tlen);
...
-file("./expr_lexer.xrl", 6).
yyaction_0(TokenChars, TokenLine) ->
     { token, { num, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("./expr_lexer.xrl", 7).
yyaction_1(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("./expr_lexer.xrl", 8).
yyaction_2(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("./expr_lexer.xrl", 9).
yyaction_3(TokenLine) ->
     { token, { '*', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("./expr_lexer.xrl", 10).
yyaction_4(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("./expr_lexer.xrl", 11).
yyaction_5(TokenLine) ->
     { token, { '~', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("./expr_lexer.xrl", 12).
yyaction_6(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("./expr_lexer.xrl", 13).
yyaction_7(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_8/0}).
-file("./expr_lexer.xrl", 14).
yyaction_8() ->
     skip_token .

-file("/usr/lib64/erlang/lib/parsetools-2.1.3/include/leexinc.hrl", 290).
